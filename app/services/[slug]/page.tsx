  ...
  return {
    ...
    description:
      typeof service.description === "string"
        ? JSON.parse(service.description)?.overview?.[0]
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {process.map((step: string, i: number) => (
                      <div
                        key={i}
                        className="flex gap-4 items-start p-4 bg-slate-50 rounded-xl border border-slate-100"
                      >
            ...
            <div className="max-w-3xl mx-auto space-y-12">
              <div className="space-y-6">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Our approach is holistic and results-oriented. We don't just
                  provide a service; we become an extension of your team.
                </p>
              </div>
