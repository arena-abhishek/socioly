        ...
        "WhyChoose.useEffect": ()=>{
            const fetchData = {
                "WhyChoose.useEffect.fetchData": async ()=>{
                    const { data: supaData } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("why_choose").select("*").single();
                    if (supaData) {
                        setData({
                            ...supaData,
...
//# sourceMappingURL=_e61f0d83._.js.map